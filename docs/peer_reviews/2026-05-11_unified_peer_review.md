...
| 5 | **Externalize one auditor** for Evidence Matrix and Status Legend. Re-grade quarterly by a human not involved in authoring. | Operator (Reuben) | Ashby, Measurement, External | Measurement: "no measurement-independent observer anywhere." Ashby: model-coherence failure. External: admirable but self-administered. |
