...
**The requirement:** One human external auditor, designated by the operator (Reuben), who:
...
| Field | Status |
|---|---|
| Auditor name | **PENDING — Reuben to designate** |
...
| Rec 2: Human external auditor | `CONVENTIONS.md` §2 — pending Reuben | **Blocked on operator** | Reuben |
...
**Next action:** Operator (Reuben) designates a human external auditor. Until then, all Evidence Matrix grades are provisional.
