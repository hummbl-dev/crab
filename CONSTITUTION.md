# CONSTITUTION.md — crab

**Status:** v0.1
**Steward:** HUMMBL Research Institute
**Approving human:** The Operator
...
Changes to this constitution require: a PR, an ADR under `docs/adr/`, a KRINEIA receipt, and human approval (The Operator). Breaking changes bump this constitution's version (SemVer) and trigger a fleet re-audit of all repos consuming this repo's outputs.
